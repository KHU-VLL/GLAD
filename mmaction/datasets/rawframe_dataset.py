...
@DATASETS.register_module()
class TOLRawframeDataset(RawframeDataset):
    """Deprecated: now features will be shuffled in the neck `TOLN`"""
    def __init__(self,
                 ann_file,
                 pipeline,
                 num_clips=3,
        ...
        #     # and TOL labels generated by _shuffle_and_relabel are gone after
